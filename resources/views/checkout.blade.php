                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="{{$productsInCartValue->image}}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                            <td class="py-5">{{$productsInCartValue->name}}</td>
                                            <td class="py-5">${{$productsInCartValue->price}}</td>
